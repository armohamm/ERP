...
Public Class GudangDAO
    ...
    Public Function save(ByRef DSO As DataSet, ByRef DA As SqlClient.SqlDataAdapter, Optional ByVal state As String = "ADD") As Boolean
        Try
            If state = "ADD" Then DSO.Tables(0).Rows(0)("kode_gudang") = getNextNumberGudang()
    ...
    Public Function getNextNumberGudang() As String
        Dim hasil, temp As String
        Dim sqlDR As SqlDataReader = New SqlCommand("select MAX( cast(substring(isnull(kode_gudang,'G01'),2,3) as numeric)) from SIF_Gudang ", conn).ExecuteReader
        sqlDR.Read()
        temp = ""
