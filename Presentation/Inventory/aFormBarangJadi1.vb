...
Public Class aFormBarangJadi1
    ...
    Private Sub loadLookUp()
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT Kd_Buku_Besar,Nm_Buku_Besar FROM SIF.dbo.SIF_Buku_Besar where grup_header = 'D' AND Kd_Buku_Besar LIKE '452%' OR Kd_Buku_Besar LIKE '453%'", sqlconn))
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT Kd_Buku_Besar,Nm_Buku_Besar FROM SIF.dbo.SIF_Buku_Besar where grup_header = 'D' AND Kd_Buku_Besar LIKE '451%' OR Kd_Buku_Besar LIKE '454%'", sqlconn))
    ...
    Private Sub PrintableComponentLink1_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportHeaderArea
        Dim reportHeader As String = "STOK BARANG JADI"
