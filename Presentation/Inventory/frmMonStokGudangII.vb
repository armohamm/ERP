...
Public Class frmMonStokGudangII
    ...
    Private Sub frmMonStokGudangII_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        Me.Enabled = True
    ...
    Sub LoadLOV()
        ...
        LookSatuan.Properties.DataSource = dsLOV.Tables("satuan")
        LookSatuan.Properties.DisplayMember = "Nama_Satuan"
        LookSatuan.Properties.ValueMember = "Kode_Satuan"
        '4
        ...
        LookUkuran.Properties.DataSource = dsLOV.Tables("ukuran")
        LookUkuran.Properties.DisplayMember = "Nama_Ukuran"
        LookUkuran.Properties.ValueMember = "Kode_Ukuran"
    ...
    Sub searchStok(Optional ByVal X As String = "", Optional ByVal satuan As String = "", Optional ByVal ukuran As String = "")
        Try
            ...
            "  where bultah = '" & X & "'   " & _
            "  and Kd_Satuan ='" & satuan & "'  " & _
            "  and kd_ukuran  =  '" & ukuran & "'   ", sqlconn))
            ...
            daStokDet = New SqlDataAdapter(New SqlCommand("select B.Kode_Gudang ,B.Nama_Gudang,A.akhir_qty,B.Keterangan,A.kd_stok ,A.bultah  " & _
            "  from INV.dbo.INV_STOK_GUDANG A,SIF.dbo.SIF_Gudang B  " & _
            "  where A.kode_gudang = B.Kode_Gudang and bultah =  '" & X & "'  " & _
            "   and Kd_Satuan ='" & satuan & "'  " & _
            "   and kd_ukuran  =  '" & ukuran & "'  " & _
            "   and kd_stok in (select kd_stok from INV.dbo.v_monstok_aseli  " & _
            "   where bultah = '" & X & "'  " & _
            "   and Kd_Satuan ='" & satuan & "'  " & _
            "   and kd_ukuran  =  '" & ukuran & "')", sqlconn))
    ...
    Sub GudangDanStok(Optional ByVal X As String = "", Optional ByVal satuan As String = "", Optional ByVal ukuran As String = "")
        ...
        "  and A.bultah = '" & X & "'  " & _
        "  and A.kd_satuan = '" & satuan & "'  " & _
        "  and A.kd_ukuran =  '" & ukuran & "'  " & _
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        ...
        searchStok(lookupBulanAwal.EditValue, LookSatuan.EditValue, LookUkuran.EditValue)
        'searchStokGudang(lookupBulanAwal.EditValue)
        GudangDanStok(lookupBulanAwal.EditValue, LookSatuan.EditValue, LookUkuran.EditValue)
