...
Public Class aFormBarangJadi2
    ...
    Private Sub lckJenis_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub

    Private Sub lckMerk_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub

    Private Sub lckTipe_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub

    Private Sub lckSubTipe_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub

    Private Sub lckUkuran_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub

    Private Sub lckKain_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        namaBarang()
    End Sub
    ...
    Private Sub kodebarang2()
        ...
        Dim sqlDR As SqlDataReader = New SqlCommand("select count(Kode_Barang)+1 from SIF.dbo.SIF_Barang where Kode_Barang LIKE '" & lckDivisi.EditValue & "1" & lckJenis.EditValue & lckMerk.EditValue & lckTipe.EditValue & lckSubTipe.EditValue & lckUkuran.EditValue & lckKain.EditValue & "%'", sqlconn).ExecuteReader
        sqlDR.Read()
    ...
    Private Sub txtNamaBarang_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
