...
Public Class aFormBarangStghJadi
    ...
    Dim daLookUp, daBarangJadi, daBarangStghJadi As SqlDataAdapter
    Dim state As String
    ...
    Private Sub loadData(ByVal kode As String)
        ...
        daBarangStghJadi = New SqlDataAdapter(New SqlCommand("SELECT * FROM SIF.dbo.SIF_Barang WHERE Kode_Barang = '" & kode & "'", sqlconn))
        daBarangStghJadi.Fill(dsBarangJadi, "Barang")
        gvBarangJadi.BestFitColumns()
    ...
    Private Sub aFormBarangStghJadi_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        Me.Enabled = True
        loadLookUp()
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        If Not isDelete Then
            ...
            If isValid Then
                If MsgBox("Simpan Master Barang 1/2 Jadi?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "SIMPAN?") = MsgBoxResult.Yes Then
                    ...
                    row.Item("rek_persediaan") = "1-621000"
        ...
        Try
            bldBarangJadi = New SqlCommandBuilder(daBarangStghJadi)
            daBarangStghJadi.UpdateCommand = bldBarangJadi.GetUpdateCommand()
            daBarangStghJadi.InsertCommand = bldBarangJadi.GetInsertCommand()
            daBarangStghJadi.DeleteCommand = bldBarangJadi.GetDeleteCommand()

            BTRANS = sqlconn.BeginTransaction("1")
            daBarangStghJadi.UpdateCommand.Transaction = BTRANS
            daBarangStghJadi.InsertCommand.Transaction = BTRANS
            daBarangStghJadi.DeleteCommand.Transaction = BTRANS

            daBarangStghJadi.Update(dsBarangJadi.Tables("Barang"))
    ...
    Private Sub txtStokMax_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub txtStokMin_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Select Case Asc(e.KeyChar)
            Case 48 To 57 'dari 0-9
                e.Handled = False
            Case 8, 45, 127
