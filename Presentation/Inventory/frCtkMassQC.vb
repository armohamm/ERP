...
Public Class frCtkMassQC
    ...
    Public Sub cetak_click()
        ...
        For Each rw As DataRow In ds.Tables("_MonQC").Select("cetak='Y'")
            Try
                Dim i As Int16 = New SqlCommand("update INV.dbo.INV_QC_M set cetak_ulang='T', cetak_ke = cetak_ke + 1 where no_trans='" & rw.Item("").ToString & "'", sqlconn).ExecuteNonQuery
                If i > 0 Then
