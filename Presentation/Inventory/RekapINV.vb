...
Public Class RekapINV
    ...
    Public Sub cetak_click()
        ...
        ViewReport(App_Path() & "\report\Rekap_INV.rpt", "", "&blthn=" & lookupBulanAwal.EditValue)
        'Else
    ...
    Private Sub cmdRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        If lookupBulanAwal.EditValue <> vbNullString Then
            cetak_click()
        Else
            MsgBox("Silahkan Lengkapi data: Bulan Tahun Periode")
        End If

    End Sub

    Private Sub RekapINV_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
