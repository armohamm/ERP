...
Public Class frmOpname_RP
    ...
    Private Sub frmOpname_RP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        DE_Tanggal.EditValue = Now
        Loadblthn()
        connect()
        prn = getParent(Me)
        GvOpnStok.Columns("qty_opname").Visible = False
