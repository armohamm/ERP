...
Public Class aFormMutasiBrgStok_BC
    ...
    Private Sub aFormMutasiBrgStok_BC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        'Me.Enabled = True
        btnEdit = True
    ...
    Private Sub txbBarcode_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txbBarcode.KeyPress
        ...
        If e.KeyChar = Chr(13) Then
            ...
            MsgBox(kd)
            Dim dtrow() As DataRow = dsMutasi.Tables("MutasiD").Select("kd_stok='" & kd & "'")
            ...
            For i As Int16 = 0 To dtrow.Count - 1
                ...
                If dsMutasi.Tables("MutasiD").Rows.Count <> 0 Then
                    ...
                    'dtrow(i)("rp_trans") = dtrow(i)("qty_order") * dtrow(i)("harga")
                    'dtrow(i)("qty_sisa") = dtrow(i)("qty_order") - dtrow(i)("qty_out")
                    ok = True
                    BindingContext(gcMutasi.DataSource).Position = getPosisi(dtrow(i))
                    tunda()
                    txbBarcode.Text = ""
                    txbBarcode.Focus()
                    'MsgBox("barang ada")
    ...
    Function getPosisi(ByVal dr As DataRow) As Integer
        Dim i As Int16 = 0
        For Each rw As DataRow In dsMutasi.Tables("MutasiD").Rows
            If dr Is rw Then
                Return i
            Else
                i += 1
