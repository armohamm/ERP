...
Public Class aFormBarangNonMaterial
    ...
    Private Sub loadLookUp()
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select Kode_Gudang,Nama_Gudang from sif.dbo.SIF_Gudang where Rec_Stat = 'Y' and Kode_Gudang='G0011'", sqlconn))
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT Kd_Buku_Besar,Nm_Buku_Besar FROM SIF.dbo.SIF_Buku_Besar where grup_header = 'D' AND Kd_Buku_Besar LIKE '452%' and Rec_Stat = 'Y'", sqlconn))
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT Kd_Buku_Besar,Nm_Buku_Besar FROM SIF.dbo.SIF_Buku_Besar where grup_header = 'D' AND Kd_Buku_Besar LIKE '451%' and Rec_Stat = 'Y'", sqlconn))
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select Kd_Jns_Persd,Nama_Persediaan from sif.dbo.SIF_Jns_Persediaan where Rec_Stat = 'Y' and Kd_Jns_Persd='6'", sqlconn))
    ...
    Private Sub loadGrid()
        ...
        daBarangJadi = New SqlDataAdapter(New SqlCommand("SELECT * FROM SIF.dbo.SIF_Barang WHERE kd_jns_persd='6'", sqlconn))
    ...
    Private Sub aFormBarangNonMaterial_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        loadLookUp()
        loadGrid()
    ...
    Sub lookup()
        ...
        daLookUp = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select Kd_Buku_Besar,Nm_Buku_Besar from sif.dbo.SIF_Buku_Besar where grup_header = 'D' and tipe_rek='C'", sqlconn))
    ...
    Private Sub kodebarang2()
        ...
        Dim sqlDR As SqlDataReader = New SqlCommand("select count(Kode_Barang)+1 from SIF.dbo.SIF_Barang where Kode_Barang LIKE '13" & lckJenis.EditValue & lckMerk.EditValue & lckTipe.EditValue & lckSubTipe.EditValue & lckUkuran.EditValue & lckKain.EditValue & "%'", sqlconn).ExecuteReader
        sqlDR.Read()
        ...
        If TypeOf sqlDR.Item(0) Is DBNull Then
            temp = "001"
            hasil = "13" & lckJenis.EditValue & lckMerk.EditValue & lckTipe.EditValue & lckSubTipe.EditValue & lckUkuran.EditValue & lckKain.EditValue & temp
        Else
            If sqlDR.Item(0) >= 1 And sqlDR.Item(0) <= 9 Then
                temp = "00" & sqlDR.Item(0)
                hasil = "13" & lckJenis.EditValue & lckMerk.EditValue & lckTipe.EditValue & lckSubTipe.EditValue & lckUkuran.EditValue & lckKain.EditValue & temp
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        If Not isDelete Then
            If isValid Then
                If MsgBox("Simpan master barang non material?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "SIMPAN?") = MsgBoxResult.Yes Then
                    JmlBarang = CekBarang()
                    ...
                    row.Item("rek_persediaan") = "10622102"
    ...
    Private Sub PrintableComponentLink1_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportHeaderArea
        Dim reportHeader As String = "STOK BARANG BAKU"
