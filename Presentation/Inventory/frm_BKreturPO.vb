...
Public Class frm_BKreturPO
        ...
        Try
            ...
            For Each row1 As DataRow In dSO1.Tables("_bke_d").Rows
                If STATE = "ADD" Then
                    ...
                    stprc_gudang_out(kdcabang, blthn(BTRANS), row1("kd_stok").ToString, row1("kd_ukuran"), row1("kd_satuan").ToString, row1("tinggi"), row1("lebar"), row1("panjang"), row1("gudang_asal").ToString, row1("qty_out"), 0, BTRANS)
                    stprc_saldo_out(kdcabang, blthn(BTRANS), row1("kd_stok").ToString, row1("kd_satuan").ToString, row1("kd_ukuran"), row1("panjang"), row1("lebar"), row1("tinggi"), row1("qty_out"), row1("rp_trans"), BTRANS)
    ...
    Public Sub cetak_click()
        callReport(App_Path() & "\report\BK_RE.rpt", "", "notrans=" & txbNoTrans.Text)
    ...
    Sub load_noretur()
        If STATE = "ADD" Then
            If Not ds_cari1.Tables("_LookupR") Is Nothing Then ds_cari1.Tables("_LookupR").Clear()
        ...
        ElseIf STATE = "EDIT" Then
            ...
            DALOOKUP1 = New SqlDataAdapter(New SqlCommand("select distinct(no_retur) from PURC.dbo.PURC_RETUR_BELI_D", sqlconn))
            DALOOKUP1.Fill(ds_cari1, "_LookupR")
            LookupNoRetur.Properties.DataSource = ds_cari1.Tables("_LookupR")
            LookupNoRetur.Properties.ValueMember = "no_retur"
            LookupNoRetur.Properties.DisplayMember = "no_retur"
    ...
    Sub load_noretur_edit()
        ...
        LookupNoRetur.Properties.DisplayMember = "no_retur"
    End Sub
    Private Sub frm_BKreturPO_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
    ...
    Public Sub stprc_gudang_out(ByVal kd_cabangx1 As String, ByVal bultah As String, ByVal kd_stokx1 As String, ByVal kd_ukuranx1 As String, ByVal satuanx1 As String, ByVal tinggix1 As Decimal, ByVal lebarx1 As Decimal, ByVal panjangx1 As Decimal, ByVal lokasix1 As String, ByVal qty_outx1 As Decimal, ByVal qty_lainx As Decimal, ByVal BTRANS As SqlTransaction)
        ...
        sqlCmd.Parameters.Add("@kode_gudang", SqlDbType.VarChar, 10).Value = lokasix1
    ...
    Private Sub formate_yayak()
        ...
        GvINV_Ret.Columns("qty_out").DisplayFormat.FormatString = "n3"
    ...
    Private Sub LookupNoRetur_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LookupNoRetur.Click
        load_noretur()
    End Sub
End Class