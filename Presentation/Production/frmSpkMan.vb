...
Public Class frmSpkMan
    ...
    Public Sub edit_click()
        Dim qstr As String = "select tanggal [Tanggal], no_spk_man [No SPK Man], no_spk [No SPK]  " & _
                "from PROD.dbo.PROD_spk_man_m where sts_centi='N' or sts_centi is NULL order by tanggal "
    ...
    Private Sub loadDetail()
        If Not ds1.Tables("spkmDetail") Is Nothing Then ds1.Tables("spkmDetail").Clear()
        da3 = New SqlDataAdapter(New SqlCommand("select d.*, '' nama_barang,'' Nama_Tipe,'' Merk_Kain,'' Nama_Ukuran, 0 sisa from PROD.dbo.PROD_spk_man_d  d where 1=0", sqlconn))
        da3.Fill(ds1, "spkmDetail")
