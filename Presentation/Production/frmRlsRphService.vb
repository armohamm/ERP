...
Public Class frmRlsRphService
    ...
    Private Sub frmRlsRph_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sqlcmd.CommandText = "select  Nama_Jenis,Jenis_Group,Nama_Jenis_Group,kd_jenis,no_rph, Nama_Merk, Nama_Tipe, Warna,kd_tipe,kd_kain, " & _
                                                                   ...
                                                                   "ukKHS = sum(case  when ukuran NOT IN ('90','110','100','120','130','140','150','160','170','180','190','200') then jumlah else 0 end), " & _
                                                                   ...
                                                                   "(sum(case ukuran when '90' then jumlah else 0 end)+ sum(case ukuran when '100' then jumlah else 0 end)+" & _
                                                                    "sum(case ukuran when '110' then jumlah else 0 end)+" & _
                                                                   "sum(case ukuran when '120' then jumlah else 0 end)+" & _
                                                                    "sum(case ukuran when '130' then jumlah else 0 end)+" & _
                                                                   ...
                                                                   "sum(case ukuran when '150' then jumlah else 0 end)+sum(case ukuran when '160' then jumlah else 0 end)+" & _
                                                                    "sum(case ukuran when '170' then jumlah else 0 end)+" & _
                                                                   "sum(case ukuran when '180' then jumlah else 0 end)+" & _
                                                                    "sum(case ukuran when '190' then jumlah else 0 end)+" & _
                                                                   "sum(case ukuran when '200' then jumlah else 0 end)+" & _
                                                                   "sum(case  when ukuran NOT IN ('90','100','110','120','130','140','150','160','170','180','190','200') then jumlah else 0 end)) as Total " & _
    ...
    Public Sub tampil_awal()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select  Nama_Jenis,Jenis_Group,Nama_Jenis_Group,kd_jenis,no_rph, Nama_Merk, Nama_Tipe, Merk_Kain,kd_tipe,kd_kain, " & _
                                                                   ...
                                                                   "uk190 = sum(case ukuran when '190' then jumlah else 0 end), " & _
                                                                   "uk200 = sum(case ukuran when '200' then jumlah else 0 end), " & _
                                                                   "ukKHS = sum(case  when ukuran NOT IN ('90','100','110','120','130','140','150','160','170','180','190','200') then jumlah else 0 end), " & _
    ...
    Public Sub tampil()
        ...
        "where kd_departemen='" & kddep & "' and jns_produksi = 'PRODUKSI' and sts_centi <> 'Y' " & _
        ...
        If Not frmCari.row Is Nothing Then
            ...
            Dim sqlcmd As New SqlCommand
            sqlcmd.CommandText = "select  Nama_Jenis,Jenis_Group,Nama_Jenis_Group,kd_jenis,no_rph, Nama_Merk, Nama_Tipe, Merk_Kain,kd_tipe,kd_merk,kd_sub_tipe , Nama_Sub_Tipe,kd_kain," & _
                                                                        "uk90 = sum(case ukuran when '90' then jumlah else 0 end), " & _
                                                                        "uk100 = sum(case ukuran when '100' then jumlah else 0 end), " & _
                                                                        "uk110 = sum(case ukuran when '110' then jumlah else 0 end), " & _
                                                                   "uk120 = sum(case ukuran when '120' then jumlah else 0 end), " & _
                                                                   ...
                                                                   "uk200 = sum(case ukuran when '200' then jumlah else 0 end), " & _
                                                                        ...
                                                                        "where s1.ukuran NOT IN ('90','100','110','120','130','140','150','160','170','180','190','200') " & _
                                                                        "and S1.no_rph = '" & frmCari.row("NO TRANS") & "' and S1.kd_jenis=s2.kd_jenis and S1.kd_tipe = s2.kd_tipe and S1.kd_sub_tipe = s2.kd_sub_tipe and S1.kd_merk=s2.kd_merk and S1.kd_kain=s2.kd_kain  For XML PATH ('')),2,500)) as ket, " & _
                                                                        "(sum(case ukuran when '90' then jumlah else 0 end)+ sum(case ukuran when '100' then jumlah else 0 end)+" & _
                                                                       "sum(case ukuran when '110' then jumlah else 0 end)+" & _
                                                                   "sum(case ukuran when '120' then jumlah else 0 end)+" & _
                                                                    "sum(case ukuran when '130' then jumlah else 0 end)+" & _
                                                                   ...
                                                                   "sum(case ukuran when '200' then jumlah else 0 end)+" & _
                                                                        ...
                                                                        "group by  Nama_Jenis,Jenis_Group,Nama_Jenis_Group,kd_jenis,no_rph, Nama_Merk, Nama_Tipe, Merk_Kain ,kd_tipe,kd_merk,kd_sub_tipe , Nama_Sub_Tipe,kd_kain order by Nama_Merk asc"
    ...
    Private Sub TextEdit1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        'tampil()
    End Sub
