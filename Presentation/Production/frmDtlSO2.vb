...
Public Class frmDtlSO2
    ...
    Private Sub frmDtlSO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da3 = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("Select d.kd_brg,d.jumlah ,b.nama_barang , p.Nama_Persediaan,b.Kd_Satuan as satuan, " & _
                                                                    "ISNULL(S.jml_available,0) jml_available , (ISNULL(S.jml_available,0) - ISNULL(d.jumlah,0) ) as sisa_stok " & _
