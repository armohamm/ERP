...
Public Class frmMonRcnRph
    ...
    Private Sub LoadLUE_NoRPH()
        ...
        Else
            ...
            daNoRPH = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("Select no_rph from PROD.dbo.PROD_rcn_prod_m " & _
                                                                            "where kd_departemen ='" & lueDep.EditValue & "' " & _
                                                                            " and  tanggal between '" & Format(deTglMulai.DateTime, "yyyy/MM/dd") & " 00:00' and '" & Format(deTglSelesai.DateTime, "yyyy/MM/dd") & " 00:00' order by no_rph desc ", sqlconn))
    ...
    Private Sub deTglSelesai_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTglMulai.EditValueChanged
        LoadLUE_NoRPH()
    End Sub
End Class