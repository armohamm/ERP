...
Public Class frmProdGenSpk
    ...
    Private Sub txtjenis_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtjenis.EditValueChanged
        ...
        da1 = New SqlDataAdapter(New SqlCommand("select kd_bom,nama_barang from" & _
                                                "(select distinct 'ALL' as kd_bom,'ALL' as nama_barang from SIF.dbo.SIF_Bom b left join SIF.dbo.SIF_Barang bar on bar.kode_barang=b.kd_bom  where kd_bom not in(select kd_bom from SIF.dbo.SIF_Bom_s )and b.jenis_bom= '" & txtjenis.EditValue & "'  union " & _
                                                "select distinct b.kd_bom as kd_bom,bar.nama_barang as nama_barang from SIF.dbo.SIF_Bom b left join SIF.dbo.SIF_Barang bar on bar.kode_barang=b.kd_bom  where kd_bom not in(select kd_bom from SIF.dbo.SIF_Bom_s )and b.jenis_bom= '" & txtjenis.EditValue & "') a  order by nama_barang asc ", sqlconn))
        da1.Fill(ds1, "Barang")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        sqlCmd.Connection = sqlconn
        sqlCmd.CommandType = CommandType.StoredProcedure
        sqlCmd.CommandText = "PROD.dbo.prodp_gen_spk"
