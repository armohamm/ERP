...
Public Class frmMonHPP
    ...
    Sub searchJurnal(Optional ByVal jurnal As String = "", Optional ByVal tipe As String = "", Optional ByVal tgldari As String = "", Optional ByVal tglsampai As String = "", Optional ByVal valuta As String = "")
        ...
        "d.val_ref1 as qty, " & _
        "REPLACE(CONVERT(varchar(20), CAST((d.saldo_rp_debet / case when d.val_ref1 = 0 then  1 else d.val_ref1 end) AS money ), 1), '.00', SPACE(0)) as harga_satuan,  " & _
        ...
        "and m.tgl_trans between  convert(date,'" & tgldari & "',103) " & _
        "and convert(date,'" & tglsampai & "',103) " & _
        "and d.keterangan = 'Barang masuk' and " & sql1 & " " & _
        "order by m.tgl_trans , d.no_jur ASC  "
        ...
        rl = dsJur.Relations.Add("RelJurDet", dsJur.Tables("jurnal").Columns("no_jur"), dsJur.Tables("jurnal_d").Columns("no_jur"), False)
        ...
        "and m.tgl_trans between  convert(date,'" & tgldari & "',103) " & _
        "and convert(date,'" & tglsampai & "',103) " & _
        "and d.saldo_rp_debet > 0 and " & sql1 & " ", sqlconn).ExecuteReader
        dr.Read()
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        For i = dsJur.Tables("jurnal").Rows.Count - 1 To 0 Step -1
            GV1.ExpandMasterRow(i, "RelJurDet")
        Next
        ...
        print_gc1(GC1, "                                                                        Daftar HPP (PRODUKSI)     " & vbCrLf & _
                       "Tanggal Transaksi     : " & Format(tglDari.EditValue, "dd/MM/yyyy") & " s/d " & Format(tglSampai.EditValue, "dd/MM/yyyy"))
        'print_gc1(GC1, "Daftar HPP (PRODUKSI)")

        For i = dsJur.Tables("jurnal").Rows.Count - 1 To 0 Step -1
            GV1.CollapseMasterRow(i, "RelJurDet")
        Next
