...
Partial Class frmProdTranSpk
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProdTranSpk))
        ...
        Me.lblTitle.Text = "TRANSAKSI SPK"
        ...
        Me.gView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.kd_barang, Me.tipe_stok, Me.kd_kain, Me.kd_ukuran, Me.jumlah_produksi, Me.jumlah_kerja, Me.indeks, Me.ColKet})
        ...
        Me.kd_kain.FieldName = "Merk_Kain"
        ...
        Me.kd_ukuran.FieldName = "Nama_Ukuran"
        ...
        'ColKet
        '
        Me.ColKet.AppearanceHeader.Options.UseTextOptions = True
        Me.ColKet.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ColKet.Caption = "Keterangan"
        Me.ColKet.FieldName = "ket"
        Me.ColKet.Name = "ColKet"
        Me.ColKet.OptionsColumn.AllowEdit = False
        Me.ColKet.Visible = True
        Me.ColKet.VisibleIndex = 6
        '
        'lktipe
        '
