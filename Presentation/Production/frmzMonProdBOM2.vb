...
Public Class frmzMonProdBOM2
    Dim dsete, dsetLUE, dsetLUE1 As New DataSet
    Dim dadbe, daLUE, daLUE1 As SqlDataAdapter
    ...
    Private Sub btnLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoad.Click
        ...
        daLUE1 = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("Select m.kd_bom,br.Nama_Barang, m.revisi, m.last_update_date, " & _
                                                                       "m.last_updated_by From SIF.dbo.SIF_BOM m " & _
                                                                       "left join SIF.dbo.SIF_bom_d d " & _
                                                                       "on d.kd_bom = m.kd_bom and m.revisi = d.revisi " & _
                                                                       "left join SIF.dbo.SIF_Barang br " & _
                                                                       "on br.Kode_Barang = m.kd_bom " & _
                                                                       "where d.kd_barang = '" & txtNama_Barang.EditValue & "'  " & _
                                                                       "and m.revisi = (Select MAX(revisi) from SIF.dbo.SIF_bom b1 where b1.kd_bom = m.kd_bom )", sqlconn))
    ...
    Private Sub frmzMonProdBOM_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        daLUE = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("Select b.Kode_Barang, b.Nama_Barang, (case b.Rec_Stat when 'Y' then 'Aktif' else 'Non Aktif' end) as Status_Barang from SIF.dbo.SIF_Barang b " & _
                                                                      "order by b.Nama_Barang asc ", sqlconn))
