...
Public Class frmz1PmhSpkInsentifBar
    Dim obj As Object
    Dim prn As frmMain
    ...
    Public Sub setStatus()
        ...
        'End With
    End Sub
    Private Sub frmzPmhSpkInsentifBar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        'reload()
    ...
    Private Sub reload(Optional ByVal notrans As String = "")
        ...
        da1 = New SqlDataAdapter(New SqlCommand("SELECT DISTINCT SIF.dbo.SIF_Gen_Reff_D.Id_Data, SIF.dbo.SIF_Gen_Reff_D.Desc_Data FROM PROD.dbo.PROD_spk_d INNER JOIN PROD.dbo.PROD_rcn_prod_m ON PROD.dbo.PROD_spk_d.no_rph = PROD.dbo.PROD_rcn_prod_m.no_rph INNER JOIN SIF.dbo.SIF_Gen_Reff_D ON PROD.dbo.PROD_spk_d.kd_kegiatan_spk = SIF.dbo.SIF_Gen_Reff_D.Id_Data where SIF.dbo.SIF_Gen_Reff_D.id_ref_file='SPK'", sqlconn))
    ...
    Private Sub isiDetil()
        ...
        da1 = New SqlDataAdapter(New SqlCommand("select distinct d.kd_barang,d.no_urut_brg,b.nama_barang,t.nama_tipe,m.merk_kain,u.nama_ukuran,d.jumlah_produksi as jumlah_realisasi,(d.jumlah_produksi- isnull(c.jumlah_kerja,0)) as sisa_rencana_prod,0.00 as jumlah_kerja, d.jumlah_sisa as jumlah_sisa,0.00 as jumlah_rework,0.00 as jumlah_delay,isnull(c.jumlah_kerja,1) as indeks " & _
                        ...
                        "left join sif.dbo.sif_kain m on b.kd_kain=m.kode_kain " & _
                        "left join sif.dbo.SIF_ukuran u on b.kd_ukuran=u.kode_ukuran " & _
                        "where x.tanggal='" & txtTgl.EditValue & "'  and d.kd_kegiatan_spk='" & txtKegiatan.EditValue & "'", sqlconn))
        da1.Fill(ds1, "detil")
        ...
        da1 = New SqlDataAdapter(New SqlCommand("select distinct d.jumlah_produksi,d.no_spk,d.kd_kegiatan " & _
                        ...
                        "left join sif.dbo.sif_kain m on b.kd_kain=m.kode_kain " & _
                        "left join sif.dbo.SIF_ukuran u on b.kd_ukuran=u.kode_ukuran " & _
                        "where x.tanggal='" & txtTgl.EditValue & "' and d.kd_kegiatan_spk='" & txtKegiatan.EditValue & "' group by d.jumlah_produksi,d.no_spk,d.kd_kegiatan", sqlconn))
        ...
        da1 = New SqlDataAdapter(New SqlCommand("select sum(d.jumlah_kerja)as jumlah_kerja,d.no_spk_man,d.kd_kegiatan " & _
                ...
                "left join sif.dbo.sif_kain m on b.kd_kain=m.kode_kain " & _
                "left join sif.dbo.SIF_ukuran u on b.kd_ukuran=u.kode_ukuran " & _
                "where x.tanggal='" & txtTgl.EditValue & "' and d.kd_kegiatan_spk='" & txtKegiatan.EditValue & "' group by d.kd_kegiatan,d.no_spk_man", sqlconn))
    ...
    Public Sub edit_click()
        ...
        If Not frmCari.row Is Nothing Then
            ...
            For Each rw As DataRow In ds1.Tables("spkmDetil").Rows
                ...
                "from PROD.dbo.PROD_rls_spk_man_d d  left join PROD.dbo.PROD_rcn_prod_m x on x.no_rph=d.no_rph " & _
                "Left join " & _
                "(select s.kd_kegiatan,s.no_spk,s.kd_barang,s.no_urut_brg,s.jumlah_produksi as jumlah_produksi,(s.jumlah_produksi - isnull(c.jumlah_kerja,0)) as sisa_rencana_prod " & _
                    "from PROD.dbo.PROD_spk_d s " & _
                    "left join(Select SUM(jumlah_kerja)as jumlah_kerja,no_spk_man,kd_kegiatan, " & _
                    ...
                    "Group by no_spk_man,kd_kegiatan,kd_barang) c " & _
                     ...
                     "left join sif.dbo.sif_kain m on b.kd_kain=m.kode_kain " & _
                     "left join sif.dbo.SIF_ukuran u on b.kd_ukuran=u.kode_ukuran " & _
                     "where x.tanggal='" & txtTgl.EditValue & "' and d.kd_kegiatan_spk='" & txtKegiatan.EditValue & "' and no_spk_man_rls='" & frmCari.row.Item("No_SPK_Rls") & "'", sqlconn).ExecuteReader
    ...
    Private Sub loadDetail()
        ...
        Dim dr As SqlDataReader = New SqlClient.SqlCommand("select P.*,S.kd_jenis,S.Nama_Barang, T.Nama_Tipe, K.Merk_Kain, U.Nama_Ukuran " & _
                                                           "from PROD.dbo.PROD_spk_man_d P left join PROD.dbo.PROD_rcn_prod_m U on U.no_rph=P.no_rph  " & _
                                                           ...
                                                           "where U.tanggal='" & txtTgl.EditValue & "' and  P.kd_kegiatan_spk='" & txtKegiatan.EditValue & "' " & _
            ...
            If e.Column Is jumlah_kerja Then
                ...
                da4 = New SqlDataAdapter(New SqlCommand("select a.no_rph no_rph, a.no_spk, a.kd_kegiatan, a.kd_kegiatan_spk, " & _
                                                " a.kd_barang kd_barang, a.jumlah_produksi  as jumlah_produksi,isnull(b.jumlah_rework,0) as jumlah_rework, " & _
                                                 ...
                                                 "from prod.dbo.prod_spk_d a left join prod.dbo.prod_rcn_prod_m y on y.no_rph=a.no_rph " & _
                                                 "left join(Select SUM(jumlah_kerja)as jumlah_kerja,no_spk_man,kd_kegiatan,jumlah_rework, " & _
                                                 "kd_barang from prod.dbo.prod_rls_spk_man_d " & _
                                                 "Group by no_spk_man,kd_kegiatan,kd_barang,jumlah_rework) b " & _
                                                 "on (a.no_spk = b.no_spk_man) " & _
                                                 ...
                                                 "and (a.kd_barang = b.kd_barang) " & _
                                                  "INNER JOIN SIF.dbo.SIF_Barang br " & _
                                                  "on br.Kode_Barang = a.kd_barang " & _
                                                 "where y.tanggal='" & txtTgl.EditValue & "' " & _
                                                        "and a.kd_kegiatan_spk= '" & txtKegiatan.EditValue & "' ", sqlconn))
    ...
    Private Sub txtTgl_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtTgl.EditValueChanged
        If Not ds1.Tables("jnsKeg") Is Nothing Then ds1.Tables("jnsKeg").Clear()
        da1 = New SqlDataAdapter(New SqlCommand("SELECT DISTINCT SIF.dbo.SIF_Gen_Reff_D.Id_Data, SIF.dbo.SIF_Gen_Reff_D.Desc_Data FROM PROD.dbo.PROD_spk_d INNER JOIN PROD.dbo.PROD_rcn_prod_m ON PROD.dbo.PROD_spk_d.no_rph = PROD.dbo.PROD_rcn_prod_m.no_rph INNER JOIN SIF.dbo.SIF_Gen_Reff_D ON PROD.dbo.PROD_spk_d.kd_kegiatan_spk = SIF.dbo.SIF_Gen_Reff_D.Id_Data where SIF.dbo.SIF_Gen_Reff_D.id_ref_file='SPK' and PROD.dbo.PROD_rcn_prod_m.tanggal='" & FormatDateTime(txtTgl.EditValue, "ddMMyyyy") & "' ", sqlconn))
