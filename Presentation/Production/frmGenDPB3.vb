...
Public Class frmGenDPB3
    ...
    Sub LoadDataBarang()
        If State = "ADD" Then
            ...
            da2 = New SqlDataAdapter(New SqlCommand("select distinct t.no_sp, '' as no_dpb ,t.no_trans, " & _
                                                    "k.kd_sopir,s.Nama_Sopir,k.kd_kenek,s1.Nama_Sopir as Nama_Kenek,v.Kd_Customer, " & _
                                                    "v.Nama_Customer, v.Nama_Wilayah, v.Nama_Area " & _
                                                    "from PROD.dbo.PROD_rcn_krm_d t " & _
                                                    "left join PROD.dbo.PRODV_MON_SO v " & _
                                                    "on v.No_sp=t.no_sp and v.No_seq_d=t.no_sp_dtl " & _
                                                    "left join PROD.dbo.PROD_rcn_krm_m k " & _
                                                    "on k.no_trans = t.no_trans " & _
                                                    ...
                                                    "on k.kd_sopir = s.Kode_Sopir " & _
                                                    "LEFT JOIN SIF.dbo.SIF_Sopir s1 " & _
                                                    "on k.kd_kenek = s1.Kode_Sopir " & _
                                                    "where t.no_trans in  " & _
                                                    "(select a.no_trans from PROD.dbo.PROD_rcn_krm_d a where a.tanggal ='" & Format(DT_Plan_Kirim.EditValue, "MM/dd/yyyy") & "' ) " & _
                                                    "and d.no_sp is NULL   ", sqlconn))
            da2.Fill(ds1, "Barang")
            ...
            da2 = New SqlDataAdapter(New SqlCommand("select distinct t.no_sp, t.no_trans, t.no_sp_dtl, t.jumlah, " & _
                                                    ...
                                                    "on v.No_sp=t.no_sp and v.No_seq_d=t.no_sp_dtl " & _
                                                    "where t.no_trans in " & _
                                                    "(select a.no_trans from PROD.dbo.PROD_rcn_krm_d a where a.tanggal ='" & Format(DT_Plan_Kirim.EditValue, "MM/dd/yyyy") & "' )", sqlconn))
            ...
            colD1(0) = ds1.Tables("Barang").Columns("no_sp")
            colD1(1) = ds1.Tables("Barang").Columns("no_trans")

            colD2(0) = ds1.Tables("BarangDetil").Columns("no_sp")
            colD2(1) = ds1.Tables("BarangDetil").Columns("no_trans")
            rl1 = ds1.Relations.Add("Detail Barang", colD1, colD2, False)
    ...
    Private Function proses(ByVal i As Int16) As String
        ...
        sqlcmd.Parameters.Add("@no_trans_krm", SqlDbType.VarChar, 40).Value = GV.GetRowCellValue(i, "no_trans")
    ...
    Private Sub btnCetak_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCetak1.Click
        cetak_click()
    End Sub
    ...
    Private Sub DT_Plan_Kirim_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DT_Plan_Kirim.EditValueChanged
        LoadDataBarang()
    End Sub
End Class