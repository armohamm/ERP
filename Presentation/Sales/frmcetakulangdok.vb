...
Public Class frmcetakulangdok
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If ComboBox1.Text = "SO" Then
            ...
            dsedit = New DataSet
            daedit = New SqlDataAdapter(New SqlCommand("select * from SALES.dbo.VSO_REP", sqlconn)) '<- query buat ditampilkan di LOV
            ...
            If Not frmCari.row Is Nothing Then
                ...
                DA1 = New SqlDataAdapter(New SqlCommand("select * from SALES.dbo.VSO_REP where No_sp  = '" & kode & "' ", sqlconn)) '<- query buat ditampilkan di LOV
                DA1.Fill(dSO, "SO")
        ...
        ElseIf ComboBox1.Text = "SJ" Then
            dsedit = New DataSet
            daedit = New SqlDataAdapter(New SqlCommand("select * from SALES.dbo.V_SJ_REP", sqlconn)) '<- query buat ditampilkan di LOV
            daedit.Fill(dsedit, "LookSPK")
            frmCari.set_dso(dsedit.Tables("LookSPK"))
            frmCari.ShowDialog()
            ...
            If Not frmCari.row Is Nothing Then
                ...
                DA1 = New SqlDataAdapter(New SqlCommand("select * from SALES.dbo.V_SJ_REP where no_sj  = '" & kode & "' ", sqlconn)) '<- query buat ditampilkan di LOV SJ
                DA1.Fill(dSO, "SJ")
