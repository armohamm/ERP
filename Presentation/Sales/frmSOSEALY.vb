...
Public Class frmSOSEALY
    ...
    Private Sub frmSO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dadbe = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select b.Kd_Satuan, b.Nama_Barang, h.Harga_Dollar ,h.Harga_Rupiah, b.Kode_Barang , '0' as isset from SIF.dbo.SIF_Barang as b, sif.dbo.sif_harga as h where b.Kd_Depart=2 and b.kd_jns_persd=1 and b.kd_jenis=210 and b.Kode_Barang=h.Kode_Barang", sqlconn))
        dadbe.Fill(dsete, "VBARANG")
        dadbe = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select Unit as Kd_Satuan, NAMA as Nama_Barang, 0 as Harga_Dollar , 0 as Harga_Rupiah, KD_SET as Kode_Barang, '1' as isset from SIF.dbo.SIF_SET_PRODUCT", sqlconn))
        dadbe.Fill(dsete, "VBARANG")
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        If Not isDelete Then
            If State = "ADD" Then
                data = New SqlCommand("select SALES.dbo.nomor(NULL, '/SLY/','" + IIf(ckPPN.CheckState, "1-", "0-") + "') ", sqlconn, BTRANS).ExecuteReader
                data.Read()
