...
Public Class frmVerivyRTL
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer from retail where kd_bank is null  ", sqlconn))
        DA.Fill(dSO, "_krd")
        ...
        If STATE = "ADD" Then
            ...
            For Each rw1 As DataRow In dSO.Tables("_krd").Rows
                If rw1.RowState = DataRowState.Modified Then
                    ...
                    If rw1.Item("stat_approve") > 0 Then
                        'MsgBox("True bos")
    ...
    Private Sub cmdRefresh_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        For Each rw1 As DataRow In dSO.Tables("_krd").Rows
            rw1.Item("kd_buku_besar") = LUE_Bank.EditValue
        Next
    End Sub
