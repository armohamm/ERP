...
Public Class frmDps_Cair
    ...
    Public Sub LoadStruktur(ByVal kode As String)
        ...
        'GcINV_Ret.DataSource = dSO1.Tables("_trans")
    End Sub
    ...
    Private Sub frmDps_Cair_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
    ...
    Private Sub tx_nama_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles tx_nama.DoubleClick
        Cari()
    End Sub
