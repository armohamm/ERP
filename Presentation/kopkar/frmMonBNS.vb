...
Public Class frmMonBNS
    ...
    Public Sub cetak_click()
        ...
        print_gc1(GcINV_Ret, "                                                                MONITORING PENGAJUAN POTONGAN    " & vbCrLf & _
                 "     ")
    ...
    Public Sub LoadStruktur()
        ...
        '              " select case when STATUS_AKTIF=0 THEN 'PENGAJUAN' WHEN STATUS_AKTIF=1 THEN 'SUDAH CAIR' END AS stat ,*,0 as nomer from kredit where status_lunas='BELUM' and jenis IN('BNS ','THR ','TAT ') ""
        Dim sql As String = "select case when stat_lunas=0 THEN 'BELUM DI DEBET' WHEN stat_lunas=1 then 'SUDAH DI DEBET' END as status_lunas,0 as nomer,* from kredit_pot where stat_lunas=0 "
