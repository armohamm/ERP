...
Public Class frmApproveKRD4
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer,(JML_POKOK+JML_BUNGA)  as JML_ANGS from kredit where stat_approve < 3 and stat_kabagSP='SETUJU'", sqlconn))
        DA.Fill(dSO, "_krd")
            ...
            For Each rw1 As DataRow In dSO.Tables("_krd").Rows
                If rw1.RowState = DataRowState.Modified Then
                    ...
                    If rw1.Item("approve1_by") = "APPROVE" Then
                        ...
                        rw1.Item("stat_approve") = 4 'ketua utama langsung cair
                    ...
                    If rw1.Item("approve4_by") = "APPROVE" Then
                        ...
                        rw1.Item("stat_approve") = 1 'ketua 4,stat=1, harus approve jg ketua 2 dan 3
    ...
    Private Sub frmApproveKRD4_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        LoadStruktur()
