...
Public Class frmMonLunasRitel
    ...
    Public Sub LoadStruktur()
        ...
        If cb_all.CheckState = CheckState.Checked Then
            DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer,jml_angsuran*sisa_angs as pj_bg from retail where status_lunas='LUNAS' " & sqltgl, sqlconn))
        ...
        Else
            DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer,jml_angsuran*sisa_angs as pj_bg from retail where status_lunas='LUNAS' AND NASABAH_ID='" & LUE_Kartu.Text & "'" & sqltgl, sqlconn))
            DA.Fill(dSO, "_krd")
            'OMI amsil RITEL
