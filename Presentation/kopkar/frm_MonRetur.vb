...
Public Class frm_MonRetur
    ...
    Public Sub LoadStruktur()
        ...
        ElseIf tglDari.EditValue <> vbNullString And tglsampai.EditValue <> vbNullString And LUE_Nama.EditValue <> vbNullString Then
            sqltgl = " TGL_TRANS between convert(date,'" & tglDari.Text & "',103) and convert(date,'" & tglsampai.Text & "',103) AND nasabah_id='" & LUE_Nama.EditValue & "'"
        ...
        Dim sql As String = "select * from tabtrans where KODE_TRANS='10' "
