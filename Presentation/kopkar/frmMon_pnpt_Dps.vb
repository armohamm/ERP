...
Public Class frmMon_pnpt_Dps
    ...
    Public Sub LoadStruktur()
        ...
        ElseIf tglDari.EditValue <> vbNullString And tglsampai.EditValue <> vbNullString And LUE_Nama.EditValue <> vbNullString Then
            sqltgl = " TGL_REGISTRASI between convert(date,'" & tglDari.Text & "',103) and convert(date,'" & tglsampai.Text & "',103) AND NASABAH_ID='" & LUE_Nama.EditValue & "'"
        End If
        ...
        If cb_all.CheckState = CheckState.Checked Then
            sql = "select *,0 as nomer,'' as nm from tabung where JENIS_TABUNGAN='005' AND " & sqltgl
        End If
    ...
    Private Sub frmMonDepst_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        LUE_Nama.Properties.ValueMember = "Nama"
