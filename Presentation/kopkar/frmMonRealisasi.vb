...
Public Class frmMonRealisasi
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select *,0 as nomer from kredit where stat_rls=1"
    ...
    Private Sub PrintableComponentLink1_CreateReportFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportFooterArea
        ...
        Dim reportFooter1 As String = "   Pembuat,               Pemeriksa,"
        Dim reportFooter2 As String = " "
        Dim reportFooter3 As String = "" & namauser & "    " & kbgSP & ""
        Dim reportFooter4 As String = "      Menyetujui   "
        Dim reportFooter6 As String = "" & kt1 & "     " & bendhr & ""
        Dim reportFooter7 As String = "Total PINJAMAN"
        Dim reportFooter8 As String = "Transfer ke Karyawan"
        Dim reportFooter11 As String = ""
        Dim reportFooter9 As String = GV_RLSKRD.Columns("JML_PINJAMAN").SummaryText
        Dim reportFooter10 As String = GV_RLSKRD.Columns("JML_TERIMA").SummaryText
        ...
        Dim rec2 As RectangleF = New RectangleF(10, 100, 10, 100)

        Dim rec3 As RectangleF = New RectangleF((e.Graph.ClientPageSize.Width / 4) - 150, 180, 300, 20)
        Dim rec4 As RectangleF = New RectangleF(((e.Graph.ClientPageSize.Width / 4) * 3) - 150, 100, 300, 20)
        Dim rec6 As RectangleF = New RectangleF(((e.Graph.ClientPageSize.Width / 4) * 3) - 150, 180, 300, 20)
