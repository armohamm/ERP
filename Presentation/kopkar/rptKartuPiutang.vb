...
Public Class rptKartuPiutang
    ...
    Private Sub LoadLookUp(ByVal kd_kartu As String)
        If Not dsLookUp.Tables("LookPeriode") Is Nothing Then dsLookUp.Tables("LookPeriode").Clear()
        DALOOKUP = New SqlDataAdapter(New SqlCommand("  Select k.TGL_PENGAJUAN,k.no_trans, j.Nama From KOPKAR.dbo.kredit k " & _
                                                     "left JOIN KOPKAR.dbo.m_jns_upload j " & _
                                                     "on j.kode = k.jenis   where k.nasabah_id = '" & kd_kartu & "'", sqlconn))
        DALOOKUP.Fill(dsLookUp, "LookPeriode")
        LUE_No_trans.Properties.DataSource = dsLookUp.Tables("LookPeriode")
        LUE_No_trans.Properties.DisplayMember = "Nama"
        LUE_No_trans.Properties.ValueMember = "no_trans"
    ...
    Public Sub cetak_click()
        ...
        ViewReport(App_Path() & "\report\kartuPiutang.rpt", "", "no_trn=" & LUE_No_trans.EditValue)
        'Else
    ...
    Private Sub rptKartuPiutang_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
    ...
    Private Sub cmdRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRefresh.Click
        cetak_click()
        'If txtcari.Text <> "" And tglDari.EditValue <> vbNullString And tglsampai.EditValue <> vbNullString And lookupBulanAwal.EditValue <> vbNullString Then
        '    cetak_click()
        'Else
        '    MsgBox("Silahkan Lengkapi data: Nama Barang, Tgl awal, Tanggal sampai dengan, Bulan Tahun Periode")
        'End If
    ...
    Private Sub LUE_Kartu_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LUE_Kartu.EditValueChanged
