...
Public Class rpt_pnpt_dps
    ...
    Private Sub LoadLookUp(ByVal kd_kartu As String)
        ...
        'DALOOKUP = New SqlDataAdapter(New SqlCommand("  select Nama,NO_TABUNGAN from v_mtabung where .nasabah_id = '" & kd_kartu & "'", sqlconn))
    ...
    Public Sub cetak_click()
        ...
        ViewReport(App_Path() & "\report\pnpt_dps.rpt", "", "tgl_dari=" & tglDari.EditValue & "&tgl_sd=" & tglsampai.EditValue)
        'Else
    ...
    Private Sub rpt_pnpt_dps_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        prn.btnAdd_Click(prn.btnAdd, New EventArgs)
        'DALOOKUP = New SqlDataAdapter(New SqlCommand(" Select NO_TABUNGAN,Nama From KOPKAR.dbo.v_mtabung ", sqlconn))
        'DALOOKUP.Fill(ds_cari, "_lookup2")
        'LUE_Kartu.Properties.DataSource = ds_cari.Tables("_lookup2")
        'LUE_Kartu.Properties.ValueMember = "NO_TABUNGAN"
    ...
    Private Sub btnprin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprin.Click
        If tglDari.EditValue <> vbNullString And tglsampai.EditValue <> vbNullString Then
            cr_view.PrintReport()
        Else
            MsgBox("Lengkapi isian pilihan: tanggal awal dan tanggal akhir", MsgBoxStyle.Critical)
    ...
    Private Sub LUE_Kartu_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
