...
Public Class rpt_bilyet
    ...
    Private Sub LoadLookUp(ByVal kd_tab As String)
        ...
        DALOOKUP = New SqlDataAdapter(New SqlCommand("select NO_TABUNGAN,Nama from v_mtabung where nasabah_id = '" & kd_tab & "'", sqlconn))
    ...
    Public Sub cetak_click()
        ...
        ViewReport(App_Path() & "\report\ctk_bilyet.rpt", "", "no_tabungan=" & LUE_No_trans.EditValue)
        'Else
    ...
    Private Sub rpt_bilyet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        prn.btnAdd_Click(prn.btnAdd, New EventArgs)
        DALOOKUP = New SqlDataAdapter(New SqlCommand(" Select NASABAH_ID,Nama From KOPKAR.dbo.v_mtabung ", sqlconn))
    ...
    End Sub
    Public Sub cetak2()
        ViewReport(App_Path() & "\report\ctk_bilyet_page2.rpt", "", "")
