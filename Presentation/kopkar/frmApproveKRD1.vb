...
Public Class frmApproveKRD1
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer,(JML_POKOK+JML_BUNGA)  as JML_ANGS from kredit where stat_approve < 4 and stat_kabagSP='SETUJU'", sqlconn))
        DA.Fill(dSO, "_krd")
