...
Public Class frmDpsCair
    ...
    Private Sub frmDpsCair_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
    ...
    Private Sub cb_bg_jln_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cb_bg_jln.CheckedChanged
        If cb_bg_jln.Checked = True Then
