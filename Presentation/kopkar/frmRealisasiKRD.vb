...
Public Class frmRealisasiKRD
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select case when STATUS_AKTIF=0 THEN 'PENGAJUAN' WHEN STATUS_AKTIF=1 THEN 'SUDAH CAIR' END AS stat,(JML_POKOK+JML_BUNGA) as angs,0 as nomer,* from kredit where status_lunas='BELUM' " 'and kd_kredit='KRD' and jenis not in ('BNS ')"
