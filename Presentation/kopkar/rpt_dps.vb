...
Public Class rpt_dps
    ...
    Public Sub cetak_click()
        ...
        ViewReport(App_Path() & "\report\dps_aktif.rpt", "")
        'Else
    ...
    Private Sub rpt_dps_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
