...
Public Class frmMonRLS
    ...
    Public Sub cetak_click()
        ...
        print_gc1(GcINV_Ret, "                                                                MONITORING REALISASI KREDIT    " & vbCrLf & _
                 "     ")
    ...
    Private Sub frmMonRLS_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        LoadStruktur("xxx")
