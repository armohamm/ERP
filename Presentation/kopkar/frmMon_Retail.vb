...
Public Class frmMon_Retail
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql_user As String = "select *,0 as nomer,'T' as gc_hapus, m_barang.nama as ppob, m_jns_barang.nama namabarang from retail LEFT JOIN m_barang ON m_barang.kd_brg=retail.kd_brg LEFT JOIN m_jns_barang ON m_jns_barang.kd_jns=retail.kd_jns_brg WHERE status_lunas='BELUM' and Last_Created_By='" & username & "'  "
