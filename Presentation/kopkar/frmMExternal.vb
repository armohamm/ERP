...
Public Class frmMExternal
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer from kredit where STATUS_LUNAS='BELUM'  order by jenis ", sqlconn)) 'and stat_anggota=1
        DA.Fill(dSO, "_krd")
    ...
    Private Sub frmMDebetExt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        DALOOKUP = New SqlDataAdapter(New SqlCommand("select kode,Nama from m_jns_upload where divisi='KRD' and tipe_trans <> 'RTL' ", sqlconn))
