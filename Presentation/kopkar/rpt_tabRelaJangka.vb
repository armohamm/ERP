...
Public Class rpt_tabRelaJangka
    ...
    Private Sub LoadLookUp(ByVal kd_tab As String)
        ...
        DALOOKUP = New SqlDataAdapter(New SqlCommand("select NO_TABUNGAN from v_RelaJangka where nasabah_id = '" & kd_tab & "'", sqlconn))
    ...
    Private Sub rpt_tabRelaJangka_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        load_vtab()

        DALOOKUP = New SqlDataAdapter(New SqlCommand("Select DISTINCT (NASABAH_ID),Nama From KOPKAR.dbo.v_RelaJangka ", sqlconn))
