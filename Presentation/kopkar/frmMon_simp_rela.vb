...
Public Class frmMon_simp_rela
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT 0 as nomer,(iuran*24) as total,* FROM TABUNG WHERE JENIS_TABUNGAN='006' " & sqltgl & " order by TGL_REGISTRASI desc ", sqlconn))
