...
Public Class frmMon_rekapPot
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select 0 as nomer,jenis,sum(jml_angsuran) as total_angs from kredit where status_lunas='BELUM' AND stat_approve >=5 and jenis in('PTAT','PBNS','PTHR','PKHS')group by jenis  "
