...
Public Class frmMonDpsCair
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select *,0 as nomer from tabung t inner join anggota a on t.NASABAH_ID=a.nasabah_id inner join tabtrans tr on t.NO_TABUNGAN=tr.NO_TABUNGAN where tr.KODE_TRANS='02' "
    ...
    Private Sub frmMonDpsCair_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        'LoadStruktur()
    ...
    Private Sub PrintableComponentLink1_CreateReportFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportFooterArea
        ...
        Dim reportFooter7 As String = "Total Pencairan"
        'Dim reportFooter8 As String = "Total Pajak"
        'Dim reportFooter11 As String = "Total Net Bunga"
        Dim reportFooter9 As String = GV_RLSKRD.Columns("SALDO_AKHIR").SummaryText
        'Dim reportFooter10 As String = GV_RLSKRD.Columns("SALDO_AKHIR").SummaryText
