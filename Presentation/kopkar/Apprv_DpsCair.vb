...
Public Class Apprv_DpsCair
    ...
    Public Sub LoadStruktur()
        ...
        'Dim sql As String = 
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer from tabtrans where KODE_TRANS='02' and kabag_approve<>1 ", sqlconn))
    ...
    Public Sub cetak_click()
        ...
        print_gc1(GcINV_Ret, "                                                                    MONITORING PENCAIRAN DEPOSITO    " & vbCrLf & _
                 "     ")
