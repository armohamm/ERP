...
Public Class frmMonDPSBunga
    ...
    Public Sub LoadStruktur()
        ...
        If tglDari.EditValue = vbNullString And tglsampai.EditValue = vbNullString And LUE_Nama.EditValue = vbNullString Then
            sqltgl = "1=0"
        ElseIf tglDari.EditValue <> vbNullString And tglsampai.EditValue = vbNullString And LUE_Nama.EditValue = vbNullString Then
        ...
        ElseIf tglDari.EditValue <> vbNullString And tglsampai.EditValue <> vbNullString And LUE_Nama.EditValue <> vbNullString Then
            sqltgl = " TGL_TRANS between convert(date,'" & tglDari.Text & "',103) and convert(date,'" & tglsampai.Text & "',103) AND t.nasabah_id='" & LUE_Nama.EditValue & "'"
        ...
        GV_RLSKRD.Columns("NASABAH_ID").SortOrder = DevExpress.Data.ColumnSortOrder.Ascending
        isinomer()
    End Sub
    ...
    Private Sub PrintableComponentLink1_CreateReportFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportFooterArea
        ...
        e.Graph.DrawString(reportFooter2, Color.Black, rec2, DevExpress.XtraPrinting.BorderSide.All)

        e.Graph.DrawString(reportFooter3, Color.Black, rec3, DevExpress.XtraPrinting.BorderSide.All)
        e.Graph.DrawString(reportFooter4, Color.Black, rec4, DevExpress.XtraPrinting.BorderSide.None)
        e.Graph.DrawString(reportFooter6, Color.Black, rec6, DevExpress.XtraPrinting.BorderSide.All)
    ...
    'Private Sub GV_RLSKRD_CalcPreviewText(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.CalcPreviewTextEventArgs) Handles GV_RLSKRD.CalcPreviewText

    'End Sub

    'Private Sub GV_RLSKRD_CustomColumnDisplayText(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs) Handles GV_RLSKRD.CustomColumnDisplayText
    '    Dim Col As DevExpress.XtraGrid.Columns.GridColumn = e.Column
    '    If Col.Name = "nomer" Then
    '        e.DisplayText = (e.RowHandle + 1)
    '    End If
    'End Sub


    'Private Sub GV_RLSKRD_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GV_RLSKRD.InitNewRow
    '    GV_RLSKRD.SetRowCellValue(e.RowHandle, "nomer", GV_RLSKRD.RowCount + 1)
    'End Sub


    '    If LUE_Nama.EditValue <> vbNullString Then
    '        cb_all.CheckState = CheckState.Unchecked
