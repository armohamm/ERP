...
Public Class frm_lunas_offline
    ...
    Public Sub Cari()
        DA_gdg1 = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand(" select a.nasabah_id,k.no_trans,a.Nama,a.Almt_asal,k.JML_PINJAMAN,k.sisa_pokok,k.JML_POKOK,k.JML_BUNGA,k.LAMA_ANGS as tempo,k.sisa_angs from kredit k left join anggota a on k.nasabah_id=a.nasabah_id where k.status_lunas='BELUM' ", sqlconn)) '<- query buat ditampilkan di LOV, pakailah alias colom biar enak dibaca
    ...
    Private Sub tx_id_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles tx_id.KeyDown
        If e.KeyCode = Keys.Enter Then
            Cari()
        End If
    End Sub
