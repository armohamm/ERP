...
Public Class frmMonTab
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer from tabung", sqlconn))
        DA.Fill(dSO, "_krd")
        GcINV_Ret.DataSource = dSO.Tables("_krd")
    End Sub

    Private Sub frmMonTab_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'btnEdit = False
        ' setStatus()
        connect()
        prn = getParent(Me)
