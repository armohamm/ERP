...
Public Class frmMon_simp_anggota1
    ...
    Public Sub LoadStruktur()
        ...
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("SELECT 0 as nomer,* from tab_wajib t  inner JOIN anggota a on t.nasabah_id=a.nasabah_id where t.rec_stat=1 " & sqltgl & "  order by a.tgl_masuk desc  ", sqlconn))
