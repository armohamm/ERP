...
Public Class frmMonTransTab
    ...
    Public Sub cetak_click()
        ...
        print_gc1(Gc_nabung, "                                                                MONITORING TRANSAKSI TABUNGAN    " & vbCrLf & _
                 "     ")
    ...
    Private Sub frmMonTransTab_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
