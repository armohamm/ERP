...
Public Class MonKreditMTS
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select case when STATUS_AKTIF=0 THEN 'PENGAJUAN' WHEN STATUS_AKTIF=1 THEN 'SUDAH CAIR' END AS stat ,*,0 as nomer from kredit where kd_kredit='MTS' "
        ...
        'DA.Fill(dSO, "_krd")
        DA2 = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select * from kredit_mtsi ", sqlconn))
        DA2.Fill(dSO, "_dtl")
    ...
    Private Sub MonKreditMTS_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        'LoadStruktur()
    ...
    Private Sub btnprin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprin.Click
        ...
        print_gc1(GcINV_Ret, "                                                                MONITORING RESCHEDULING PERUBAHAN ANGSURAN KREDIT    " & vbCrLf & _
                 "     ")
