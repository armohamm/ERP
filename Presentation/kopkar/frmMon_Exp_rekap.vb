...
Public Class frmMon_Exp_rekap
    ...
    Public STATE, id_anggota, jns, subReport As String '<-- untuk mengecek status saat ini (ADD, EDIT, delete)
    ...
    Private Sub PrintableComponentLink1_CreateReportFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportFooterArea
        ...
        Dim reportFooter7 As String = "Total DEBET"
    ...
    Private Sub PrintableComponentLink1_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportHeaderArea
        Dim reportHeader As String = "LAPORAN DEBET KOPERASI MITRA SEJAHTERA"
        'Dim reportHeader1 As String = "Per Tanggal "
        'If lookupBulanAwal.EditValue = tglsampai.EditValue Then
        subReport = "BULAN TAHUN " & lookupBulanAwal.EditValue
        'Elseu
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select 0 as nomer,jenis_debit,sum(rupiah) as rupiah,blthn from export_log where blthn='" & lookupBulanAwal.EditValue & "' GROUP by jenis_debit,blthn "
    ...
    Private Sub frmMon_Exp_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        connect()
        prn = getParent(Me)
        'LoadStruktur()
