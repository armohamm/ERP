...
Public Class Apprv_ritel
    ...
    Public Sub LoadStruktur()
        ...
        '    End If
        'End If
        DA = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,0 as nomer from retail where kabag_approve=0 ", sqlconn))
    ...
    Public Sub simpan(Optional ByRef isDelete As Boolean = False)
        ...
        Try
            ...
            For Each rw1 As DataRow In dSO.Tables("_krd").Select("kabag_approve=True")
                '    If row.RowState = DataRowState.Modified Then
                call_procedure(row.Item("no_trans"), BTRANS)
                '        sqlcmd1.ExecuteNonQuery()
                '    End If
            Next
    ...
    Public Sub call_procedure(ByVal no_pengajuan As String, ByVal b_trans As SqlTransaction)
        Dim sqlCmd As New SqlCommand
        sqlCmd.Connection = sqlconn
        sqlCmd.Transaction = b_trans
        sqlCmd.CommandType = CommandType.StoredProcedure
        sqlCmd.CommandText = "KOPKAR.dbo.FIN_CREATE_JUR_PIUTANG_RTL"
