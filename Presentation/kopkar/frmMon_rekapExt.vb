...
Public Class frmMon_rekapExt
    ...
    Private Sub PrintableComponentLink1_CreateReportFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportFooterArea
        ...
        Dim reportFooter8 As String = "Jumlah Fee Kop"
        'Dim reportFooter11 As String = "Total Debet"
        Dim reportFooter9 As String = gv_byr_piu.Columns("total_debet").SummaryText
        Dim reportFooter10 As String = gv_byr_piu.Columns("ke_koperasi").SummaryText
    ...
    Public Sub LoadStruktur()
        ...
        Dim sql As String = "select 0 as nomer,kd_grup,sum(total_debet) as total_debet,sum(ke_koperasi) as ke_koperasi from m_debet_ext group by kd_grup  "
    ...
    Private Sub frmMon_ritel_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        DALOOKUP1 = New SqlDataAdapter(New SqlCommand("select kd_grup,nama_grup from m_grup_debet_ext", sqlconn))
        DALOOKUP1.Fill(ds_cari1, "_jns")
        RL_Jenis.DataSource = ds_cari1.Tables("_jns")
        RL_Jenis.ValueMember = "kd_grup"
        RL_Jenis.DisplayMember = "nama_grup"
