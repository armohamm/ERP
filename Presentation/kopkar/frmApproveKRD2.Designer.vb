...
Partial Class frmApproveKRD2
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmApproveKRD2))
        ...
        Me.GV_RLSKRD.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.nomer, Me.tgl_trans, Me.Nama, Me.jenis, Me.JML_PINJAMAN, Me.JML_ANGS, Me.LAMA_ANGS, Me.approve2_by, Me.catatan2})
        ...
        'approve2_by
        '
        Me.approve2_by.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(0, Byte), Integer), CType(CType(192, Byte), Integer), CType(CType(0, Byte), Integer))
        Me.approve2_by.AppearanceCell.Options.UseBackColor = True
        Me.approve2_by.Caption = "Approve 2"
        Me.approve2_by.ColumnEdit = Me.cbe_appr
        Me.approve2_by.FieldName = "approve2_by"
        Me.approve2_by.Name = "approve2_by"
        Me.approve2_by.Visible = True
        Me.approve2_by.VisibleIndex = 7
        Me.approve2_by.Width = 62
        '
        'cbe_appr
        '
        ...
        Me.Label1.Text = "         APPROVAL PERMOHONAN KREDIT OLEH KETUA 2"
