...
Public Class aFormLunasPiutangUsahaNonDOSpon2
    ...
    Private Sub V_giro()
        ...
        Lookgiro.Properties.DisplayMember = "idrec"
    End Sub
    ...
    Public Sub reload_table(ByVal kode As String)
        ...
        If STATE = "ADD" Then
            daNotaLD = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,CAST('01/01/2014' AS DATE) as tgl_inv, 0 as jmltagihan,'' as jenis, 'T' as cek from FIN.dbo.FIN_NOTA_LUNAS_D where no_trans= '" & kode & "'", sqlconn))
