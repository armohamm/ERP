...
Public Class frmJurnalJKK
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        If Not isDelete Then
            ...
            If isvalid Then
                If STATE = "ADD" Then
                    txtNoJur.EditValue = getNoTrans("JKK", getTanggal(), BTRANS)
