...
Public Class aFormLunasPiutangUsahaDO
    ...
    Private Sub v_nota()
        ...
        Else
            daNota = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select * from FIN.dbo.FIN_Nota where kd_cust='" & lookcust.EditValue & "' and kd_valuta='" & LEValuta.EditValue & "' and tipe_trans = 'JPJ-KPT-02'", sqlconn))
        End If
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        Try
            ...
            If Not isDelete Then
                ...
                Else
                    call_procedure("JRR-KPT-16", kode, BTRANS)
                End If
            End If
