...
Public Class aFormLunasPiutangUsahaNonDOSpon1
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        If Not isDelete Then
            ...
            If STATE = "ADD" Then
                ...
                txtNomor.EditValue = getNoTrans("JKM", getTanggal(BTRANS), BTRANS)
    ...
    Public Sub reload_table(ByVal kode As String)
        ...
        daNotaLD = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select *,GetDate() as tgl_inv,'' as jmltagihan,'' as jenis, 'T' as cek from FIN.dbo.FIN_NOTA_LUNAS_D where no_trans= '" & kode & "'", sqlconn))
    ...
    Private Sub aFormLunasPiutangUsahaNonDOSpon_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        View_Valuta()
        V_Customer()
    ...
    Private Sub GVDetil_CellValueChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GVDetil.CellValueChanged
        ...
        Next
        txtJmlSub.EditValue = jumlah
        lblSelisih.Text = "Selisih : " & CStr(formatNumber(CStr(txtPembayaran.EditValue - txtJmlSub.EditValue)))
    End Sub
