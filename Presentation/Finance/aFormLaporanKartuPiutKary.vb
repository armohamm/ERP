...
Public Class aFormLaporanKartuPiutKary
    ...
    Private Sub loadLookUp()
        ...
        daLookKartu = New SqlDataAdapter(New SqlCommand("SELECT DISTINCT a.kd_cust, b.nama FROM FIN.dbo.FIN_NOTA a, FIN.dbo.v_kartu b WHERE a.kd_cust=b.kode AND a.kd_valuta='" & lookupValuta.EditValue & "' AND a.tipe_trans LIKE 'JKK-KPT-01' UNION SELECT '00000', '[Semua Data]'", sqlconn))
    ...
    Private Sub aFormLaporanKartuPiutKary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        Me.Enabled = True
        ...
        If isOK = True Then
            ...
            If radKartuPiut.Checked = True Then
                If cmbKartuPiut.EditValue = "Rekap" Then
                    callReport(App_Path() & "\report\repKartuRekapKarComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue, False)
                ElseIf cmbKartuPiut.EditValue = "Rinci" Then
                    If lookupKartu.EditValue = vbNullString Or lookupKartu.EditValue = "00000" Then
                        callReport(App_Path() & "\report\repKartuRinciKarAllComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue, False)
                    Else
                        callReport(App_Path() & "\report\repKartuRinciKarComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue & "&kartu=" & lookupKartu.EditValue & "&inv=", False)
                    End If
                End If
            End If
        Else
    ...
    Private Sub btnCetak_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCetak.Click
        ...
        If isOK = True Then
            ...
            If radKartuPiut.Checked = True Then
                If cmbKartuPiut.EditValue = "Rekap" Then
                    callReport(App_Path() & "\report\repKartuRekapKarComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue, True)
                ElseIf cmbKartuPiut.EditValue = "Rinci" Then
                    If lookupKartu.EditValue = vbNullString Or lookupKartu.EditValue = "00000" Then
                        callReport(App_Path() & "\report\repKartuRinciKarAllComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue & "&inv=", True)
                    Else
                        callReport(App_Path() & "\report\repKartuRinciKarComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&val=" & lookupValuta.EditValue & "&kartu=" & lookupKartu.EditValue & "&inv=", True)
                    End If
                End If
            End If
        Else
