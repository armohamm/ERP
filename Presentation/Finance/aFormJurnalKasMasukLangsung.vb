...
Public Class aFormJurnalKasMasukLangsung
            ...
            Try
                If Not isDelete Then
                    If STATE = "ADD" Then
                        ...
                        row.Item("tipe_trans") = "JKM-KBB-04"
    ...
    Private Sub cek()
        ...
        If Not lueValuta.EditValue = "IDR" Then
            If txtValuta.Text = 1 Then
                ...
                If gvJurnal.Columns("saldo_val_kredit").SummaryText.Equals(vbNullString) Or gvJurnal.Columns("saldo_val_kredit").SummaryText.Equals("0,00") Then
                    If Not gvJurnal.Columns("saldo_val_kredit").SummaryItem.SummaryValue = txt_JumlahBayar.EditValue Then
                ...
                End If
            End If
            'ElseIf Not gvJurnal.Columns("saldo_val_kredit").SummaryItem.SummaryValue = txt_JumlahBayar.EditValue Then
            '    isvalid = False
            '    err &= "Jumlah Valuta debet dan kredit tidak sama." & vbCrLf
    ...
    Private Sub loadList()
        ...
        daBB = New SqlDataAdapter(New SqlCommand("SELECT ( " & _
                                                ...
                                                "FROM KOPKAR.dbo.m_buku_besar " & _
                                                "WHERE grup_header='D' AND grup_level3 LIKE '4%' and " & _
    ...
    Sub hitung_selisih()
        ...
        If dsJurnal.Tables("JurnalD").Compute("sum(saldo_val_kredit)", "").ToString <> "" Then jumlah_debet = dsJurnal.Tables("JurnalD").Compute("sum(saldo_val_kredit)", "")
    ...
    Private Sub gvJurnal_RowUpdated(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowObjectEventArgs) Handles gvJurnal.RowUpdated
        hitung_selisih()
        txt_JumlahBayar.EditValue = gvJurnal.Columns("saldo_val_kredit").SummaryItem.SummaryValue
    End Sub
End Class