...
Public Class aFormLunasPiutangUsahaNonDOSpon
    ...
    Private Sub V_giro()
        ...
        Else
            ...
            daGiro = New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("select nomor, keterangan,tgl_jth_tempo, jml_trans from FIN.dbo.FIN_GIRO where divisi = '3' and kartu='" & lookcust.EditValue.ToString & "' and jns_giro='" & lookbayar.EditValue.ToString & "' and kd_valuta='" & LEValuta.EditValue.ToString & "' and jns_trans='JUAL' and tipe_trans='JRR-KPT-10' and status='CLEARING' and nomor not in (select distinct isnull(no_giro,'kosong') from FIN.dbo.FIN_NOTA_LUNAS where tipe_trans in ('JPJ-KPT-02', 'JPJ-KPT-04')) AND NOT (no_jur IS NULL OR no_jur = '')", sqlconn))
        End If
