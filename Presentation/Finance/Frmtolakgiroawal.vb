...
Public Class Frmtolakgiroawal
    ...
    Private Sub loadLookUp()
        ...
        daVGiro = New SqlDataAdapter(New SqlCommand("SELECT a.nomor, a.kartu, a.tgl_jth_tempo, a.kd_bank, a.jml_trans, b.nama, c.nama_bank FROM FIN.dbo.FIN_GIRO a, FIN.dbo.v_kartu b, SIF.dbo.SIF_Bank c WHERE a.kartu=b.kode AND a.kd_bank=c.kd_bank AND a.status LIKE 'DITERIMA'", sqlconn))
