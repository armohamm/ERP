...
Public Class frmProsJurnalBiayaDmuka
    ...
    Private Sub frmProsJurnalBiayaDmuka_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        Me.Enabled = True
    ...
    Private Sub cmdExe_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdExe.Click
        Try
            call_procedure(lookupBulanAwal.EditValue, "JKK-KBB-06", Nothing)
