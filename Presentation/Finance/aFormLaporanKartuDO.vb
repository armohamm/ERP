...
Public Class aFormLaporanKartuDO
    ...
    Private Sub aFormLaporanKartuDO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        connect()
        prn = getParent(Me)
        Me.Enabled = True
    ...
    Private Sub btnPrev_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrev.Click
        ...
        If isOK = True Then
            If lookupKartu.EditValue = vbNullString Or lookupKartu.EditValue = "00000" Then
                'callReport(App_Path() & "\report\repKartuRinciAllComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&valuta=" & lookupValuta.EditValue, False)
            Else
                'callReport(App_Path() & "\report\repKartuRinciComm.rpt", "", "periode=" & lookupPeriode.EditValue & "&valuta=" & lookupValuta.EditValue & "&kartu=" & lookupKartu.EditValue, False)
            End If
        Else
