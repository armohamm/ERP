...
Public Class aFormLunasPiutangUsahaDOSpring2
    ...
    Private Sub bersih()
        ...
        txtJenis.EditValue = vbNullString
    End Sub
        ...
        Try
            ...
            If Not isDelete Then
                If bayar = "04" Then
                    ...
                    txtNomor.EditValue = getNoTransFin("JKMB", dtTanggal.EditValue, "B" + CStr(bank), BTRANS)
                ElseIf bayar = "02" Or bayar = "01" Then
                    txtNomor.EditValue = getNoTransFin("JKMB", dtTanggal.EditValue, "G" + giro, BTRANS)
                Else
