...
Public Class RptKapasitas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.RptKapasitas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptKapasitas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptKapasitas = New RptKapasitas
        rpt.Site = Me.Site
        Return rpt
    End Function
