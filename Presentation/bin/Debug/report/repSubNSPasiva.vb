...
Public Class repSubNSPasiva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.repSubNSPasiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_val() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrepSubNSPasiva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repSubNSPasiva = New repSubNSPasiva
        rpt.Site = Me.Site
        Return rpt
    End Function
