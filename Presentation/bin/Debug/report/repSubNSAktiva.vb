...
Public Class repSubNSAktiva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.repSubNSAktiva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepSubNSAktiva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repSubNSAktiva = New repSubNSAktiva
        rpt.Site = Me.Site
        Return rpt
    End Function
