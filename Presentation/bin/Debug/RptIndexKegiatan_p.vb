...
Public Class RptIndexKegiatan_p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.RptIndexKegiatan_p.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pkegiatan() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pppic() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptIndexKegiatan_p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptIndexKegiatan_p = New RptIndexKegiatan_p
        rpt.Site = Me.Site
        Return rpt
    End Function
