...
Public Class RptIndexKegiatan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.RptIndexKegiatan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptIndexKegiatan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptIndexKegiatan = New RptIndexKegiatan
        rpt.Site = Me.Site
        Return rpt
    End Function
