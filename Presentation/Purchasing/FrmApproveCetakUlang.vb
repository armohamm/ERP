...
Public Class FrmApproveCetakUlang
    ...
    Public Sub simpan()
        ...
        showMessages("Data berhasil diupdate!")
    End Sub
    ...
    Sub Load_PO_Filter()
        ...
        'If tglDari.Text = "" Then
        '    If tglsampai.Text <> "" Then
        '        sql = " where convert(varchar, tgl_po, 103) < " & tglsampai.Text
        '    End If
        'Else

        '    If tglsampai.Text <> "" Then
        '        sql = " where convert(varchar, tgl_po, 103)  between '" & tglDari.Text & "' and '" & tglsampai.Text & "' "
        '    Else
        '        sql = " where convert(varchar, tgl_po, 103)  > " & tglDari.Text
        '    End If
        'End If
        ...
        Else
            ...
            If tglsampai.Text <> "" Then
                sql = " convert(varchar, tgl_po, 103) between '" & tglDari.EditValue & "' and '" & tglsampai.EditValue & "' "
            Else
