...
Public Class FrmMonPObrg
    ...
    Sub Load_PO_Filter()
        ...
        DA3 = New SqlDataAdapter(New SqlCommand("SELECT * from INV.dbo.INV_GUDANG_IN a inner join INV.dbo.INV_GUDANG_IN_D b on a.no_trans=b.no_trans and a.tipe_trans=b.tipe_trans inner join sif.dbo.sif_gudang c on c.Kode_Gudang = b.gudang_tujuan where a.no_ref in (select no_po from PURC.dbo.PURC_PO)", sqlconn))
