...
Public Class frmPOex
    ...
    Public Sub cetak_click()
        ...
        If txtNoPO.Text = "" Then
            ...
            Exit Sub
        End If
        callReport(App_Path() & "\report\rptPOM_1.rpt", "", "&no_po=" & Trim(txtNoPO.Text) & " &vnama_report=" & TemplatePur, False, False)
    ...
    Sub hitung_total()
        If txtSubTotal.EditValue <> vbNullString Or txtSubTotal.EditValue <> vbNullString Then


            '        'MsgBox("Sub Total Masih Kosong,Silahkan Lakukan Transaksi ", MsgBoxStyle.Information, "Perhatian")
            '        Exit Sub
            '    Else
            '        hitung_total()kjkjkjk
            '    End If
            If CEPPN.Checked = True Then
                CEPPN.Text = "PPN"
            Else
            ...
            If ce_exclude.Checked = True Then
                CEPPN.Properties.ReadOnly = True
                CEPPN.Checked = True
                ce_exclude.Text = "INCLUDE PPN"
                'txtSubTotal.EditValue = hh * 1.1
                txtSubTotal.EditValue = hh / 1.1
                txtJmlPPN.EditValue = (txtSubTotal.EditValue - txtJmlDiskon1.EditValue) * (10 / 100)
                'txtJmlTotal.EditValue = txtSubTotal.EditValue - txtJmlPPN.EditValue
            ...
            Else
                CEPPN.Properties.ReadOnly = False
                ce_exclude.Text = "EXCLUDE PPN"
                txtSubTotal.EditValue = hh
                txtJmlPPN.EditValue = (txtSubTotal.EditValue - txtJmlDiskon1.EditValue) * (10 / 100)
                If CEPPN.Checked = True Then
                    txtJmlTotal.EditValue = Val(Val(txtSubTotal.EditValue) - Val(txtJmlDiskon1.EditValue)) + Val(txtJmlPPN.EditValue)
                Else
                    txtJmlTotal.EditValue = Val(Val(txtSubTotal.EditValue) - Val(txtJmlDiskon1.EditValue))
                    txtJmlPPN.EditValue = 0
                End If
    ...
    Private Sub ce_exclude_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ce_exclude.CheckedChanged
        If txtSubTotal.Text = "" Or txtSubTotal.Text = "0" Then
            'MsgBox("Sub Total Masih Kosong,Silahkan Lakukan Transaksi ", MsgBoxStyle.Information, "Perhatian")
            Exit Sub
        Else
