...
Public Class frmPOBatal2
    ...
    Public Sub save_click(Optional ByRef isDelete As Boolean = False)
        ...
        If Not isDelete Then
            ...
            row.Item("status") = "BATAL"
            txtstatus.Text = row.Item("Status")
            row.Item("tgl_batal") = dtBayar.EditValue
    ...
    Private Sub reload_table(ByVal kode As String)
        ...
        If ds3.Tables("PO").Rows.Count > 0 Then
            ...
            dtBayar.Text = row.Item("tgl_batal").ToString
            txtketBatal.Text = row.Item("ket_batal").ToString
